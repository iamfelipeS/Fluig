function defineStructure() {
	...
	addColumn("COD");                       
	addColumn("REDESPACHO_MATRIZ");         
	addColumn("REDESPACHO_MATRIZ_COMPLETO");
...
function onSync(lastSyncDate) {
    ...
    dataset.addColumn("REDESPACHO_MATRIZ");
    dataset.addColumn("REDESPACHO_MATRIZ_COMPLETO");
    var clientService = fluigAPI.getAuthorizeClientService();
   
    var data = {
        companyId: ""+ getValue('WKCompany')+ "",
        serviceCode: 'SERVICO_PROTHEUS', // Mesmo domain, sem necessidade de criar outro servico
        endpoint: '/rest/kilws160/get_zoom?a1_zoom=a1redrs',
        method: 'GET',
        timeoutService: '1000',
        options: {
            useSSL: true

function defineStructure() {
	...
	addColumn("COD");                  
	addColumn("PLANEJAMENTO");         
	addColumn("PLANEJAMENTO_COMPLETO");
...
function onSync(lastSyncDate) {
	 ...
	 var dataset = DatasetBuilder.newDataset();
	    ...
	    dataset.addColumn("PLANEJAMENTO");
	    dataset.addColumn("PLANEJAMENTO_COMPLETO");
	    var clientService = fluigAPI.getAuthorizeClientService();
	   
	    var data = {
	        companyId: ""+ getValue('WKCompany')+ "",
	        serviceCode: 'SERVICO_PROTHEUS', // Mesmo domain, sem necessidade de criar outro servico
	        endpoint: '/rest/kilws160/get_zoom?a1_zoom=a1planest',
	        method: 'GET',
	        timeoutService: '1000',
	        options: {
	            useSSL: true

...
function defineStructure() {
	...
	addColumn("COD");                       
	addColumn("TRANSP_MATRIZ");             
	addColumn("TRANSP_MATRIZ_COMPLETO");    
...
function onSync(lastSyncDate) {
    ...
    dataset.addColumn("TRANSP_MATRIZ");
    dataset.addColumn("TRANSP_MATRIZ_COMPLETO");
    var clientService = fluigAPI.getAuthorizeClientService();
   
    var data = {
        companyId: ""+ getValue('WKCompany')+ "",
        serviceCode: 'SERVICO_PROTHEUS', // Mesmo domain, sem necessidade de criar outro servico
        endpoint: '/rest/kilws160/get_zoom?a1_zoom=a1transp',
        method: 'GET',
        timeoutService: '1000',
        options: {
            useSSL: true

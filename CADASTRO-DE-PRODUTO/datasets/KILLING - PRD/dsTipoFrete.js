function defineStructure() {
	...
	addColumn("COD");                
	addColumn("TIPO_FRETE");         
	addColumn("TIPO_FRETE_COMPLETO");   
...
function onSync(lastSyncDate) {
    ...
    dataset.addColumn("TIPO_FRETE");
    dataset.addColumn("TIPO_FRETE_COMPLETO");
    var clientService = fluigAPI.getAuthorizeClientService();
   
    var data = {
        companyId: ""+ getValue('WKCompany')+ "",
        serviceCode: 'SERVICO_PROTHEUS', // Mesmo domain, sem necessidade de criar outro servico
        endpoint: '/rest/kilws160/get_zoom?a1_zoom=a1tpfrete',
        method: 'GET',
        timeoutService: '1000',
        options: {
            useSSL: true

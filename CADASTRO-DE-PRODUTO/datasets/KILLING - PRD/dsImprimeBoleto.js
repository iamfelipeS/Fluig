function defineStructure() {
	...
	addColumn("COD");                      
	addColumn("IMPRIME_BOLETO");           
	addColumn("IMPRIME_BOLETO_COMPLETO");  
...
function onSync(lastSyncDate) {
    ...
    dataset.addColumn("IMPRIME_BOLETO");
    dataset.addColumn("IMPRIME_BOLETO_COMPLETO");
    var clientService = fluigAPI.getAuthorizeClientService();
   
    var data = {
        companyId: ""+ getValue('WKCompany')+ "",
        serviceCode: 'SERVICO_PROTHEUS', // Mesmo domain, sem necessidade de criar outro servico
        endpoint: '/rest/kilws160/get_zoom?a1_zoom=a1blemail',
        method: 'GET',
        timeoutService: '1000',
        options: {
            useSSL: true

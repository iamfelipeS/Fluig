...
function createDataset(fields, constraints, sortFields) {
	try {
		...
		var query = "";
		query += " SELECT DB0_FILIAL AS FILIAL, DB0_CODMOD AS CODIGO, DB0_TIPCAR AS TIPCAR, DB0_DESMOD AS DESCRICAO FROM FLUIG.VIEW_MODELOS_CARGA";
		//query += " WHERE DB0.D_E_L_E_T_ = '' "
